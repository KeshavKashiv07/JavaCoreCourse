...
public class ElectricalEngin extends Engines{
	
	private String name;
	private String varient;
	
      public ElectricalEngin(String modelNumber, int displacement, int maxPower, int maxRpm ,String name,  String varient) {
